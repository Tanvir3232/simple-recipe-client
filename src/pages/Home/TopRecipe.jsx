...
const TopRecipe = () => {
    return (
        <div>
            <h1 className='text-5xl my-12 font-medium text-center'>Top Recipes of the Day</h1>
            <div className="carousel w-full">
                <div id="item1" className="carousel-item w-full flex gap-6">
                ...
                <div id="item2" className="carousel-item w-full flex gap-6">
                ...
                <div id="item3" className="carousel-item w-full flex gap-6">
